...
``` bash
$ npm install distributions-t-quantile
```
...
``` javascript
var quantile = require( 'distributions-t-quantile' );
```

#### quantile( p[, options] )

Evaluates the [quantile function](https://en.wikipedia.org/wiki/Quantile_function) for the [Student t](https://en.wikipedia.org/wiki/Student t_distribution) distribution. `p` may be either a [`number`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number) between `0` and `1`, an [`array`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array), a [`typed array`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Typed_arrays), or a [`matrix`](https://github.com/dstructs/matrix).
...
[npm-image]: http://img.shields.io/npm/v/distributions-t-quantile.svg
[npm-url]: https://npmjs.org/package/distributions-t-quantile
...
[dev-dependencies-image]: http://img.shields.io/david/dev/distributions-io/t-quantile.svg
[dev-dependencies-url]: https://david-dm.org/dev/distributions-io/t-quantile

[github-issues-image]: http://img.shields.io/github/issues/distributions-io/t-quantile.svg
[github-issues-url]: https://github.com/distributions-io/t-quantile/issues
